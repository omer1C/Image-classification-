...
path = Path('/Users/omercohen/PycharmProjects/ImageClassification/')
...
def data_prepare(data_path):
  images = []
  new_path = '/Users/omercohen/PycharmProjects/ImageClassification/'+data_path
  for file in Path(new_path).iterdir():
      ...
      images.append([filename,((np.array(img)[:, :, :3]/ 255.0) - 0.5)]) # add and normelized the data
